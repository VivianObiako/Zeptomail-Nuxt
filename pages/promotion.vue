      ...
      <div class="promotion-top">
        <v-row>
          <v-col md="8" offset-md="2" class="text-center">
            ...
            <p class="mt-4">
              We have the lowest pricing in Washington state, and we have strategically set up our
              internal systems to cut costs and leave clients with the best rates they need.
              Fill out the form below to upload your recent estimate and enjoy our superb electrical services in
              Washington.
            </p>
          </v-col>
        </v-row>
...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      {
        hid: 'description',
        name: 'description',
        content: 'Wondering how to start a small electrical contractor business in Washington? You don\'t have' +
          ' to fly solo. Own a Jacob Electric franchise' +
          ' and enjoy a seamless and lucrative business in no time.\n'
      },
      {
        hid: 'keywords',
        name: 'keywords',
        content: 'how to start a small electrical contractor business, electrical business opportunities, how to start an electrical contracting business"\ny'
      },
    ],
  },
  components: {
  ...
  methods: {
    submit() {
      ...
      this.$axios
        .$post("/zeptomail/promotion", formData, {
          baseURL: '',
          headers: {
